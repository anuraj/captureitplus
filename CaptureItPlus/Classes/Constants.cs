namespace CaptureItPlus
{
    public static class Constants
    {
        ...
        public const string APP_EXCEPTION = "An application exception occurred in CaptureIt Plus.{0}Please report the issue to http://captureitplus.codeplex.com.{0}Please attach the captureitplus.log file, which helps us to identify and fix the problem.";
