        ...
        private void DrawShape(Graphics graphics)
        {
            switch (_captureMode)
            {
                case Common.CaptureModes.Rectangle:
                    ...
                    if (_isDrawing)
                    {
                        graphics.DrawString(string.Format("Width : {0} Height : {1}", rect.Width, rect.Height), Font, Brushes.Black, new Point(rect.Right + 5, rect.Bottom + 5));
                    }
                ...
                case Common.CaptureModes.Circle:
                    ...
                    if (_isDrawing)
                    {
                        graphics.DrawString(string.Format("Width : {0} Height : {1}", circleRect.Width, circleRect.Height), Font, Brushes.Black, new Point(circleRect.Right + 5, circleRect.Bottom + 5));
                    }
