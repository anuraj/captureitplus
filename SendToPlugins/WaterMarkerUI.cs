...
namespace SendToPlugins
{
    public partial class WaterMarkerUI : Form
    {
            ...
            : this()
        {
            ...
            try
            {
                var configFileName = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "CaptureItPlus");
            ...
            {
                Console.WriteLine("Ignoring all exceptions");
            }
        }
